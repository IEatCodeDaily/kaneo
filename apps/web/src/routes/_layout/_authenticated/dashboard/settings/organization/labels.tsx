...
function RouteComponent() {
  ...
  const { organization, canManageLabels } = useOrganizationPermission();
  const canEdit = canManageLabels();

  const organizationId = organization?.id ?? "";

  const { data: labels = [] } = useGetLabelsByOrganization(organizationId);
  const organizationLabels = labels.filter((label) => !label.taskId);
  ...
  const handleCreate = async () => {
    ...
    if (!trimmed) {
      setCreateError(
        t("settings:organizationLabels.nameRequired", {
    ...
    try {
      ...
      toast.success(
        t("settings:organizationLabels.createSuccess", {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : t("settings:organizationLabels.createError", {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      toast.success(
        t("settings:organizationLabels.updateSuccess", {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : t("settings:organizationLabels.updateError", {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success(
        t("settings:organizationLabels.deleteSuccess", {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : t("settings:organizationLabels.deleteError", {
  ...
  return (
    <>
      <PageTitle title={t("settings:organizationLabels.pageTitle")} />
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold">
            {t("settings:organizationLabels.title", { defaultValue: "Labels" })}
          </h1>
          ...
          <Card className="!rounded-none !border-t-0">
            <CardHeader>
              <CardTitle className="inline-flex items-center gap-2 text-base">
                ...
                {t("settings:organizationLabels.title", {
                  defaultValue: "Labels",
                })}
              </CardTitle>
              <CardDescription>
                {t("settings:organizationLabels.cardDescription", {
              ...
              {canEdit && (
                <CardAction>
                  <Button onClick={openCreate} className="gap-2">
                    ...
                    {t("settings:organizationLabels.createLabel", {
              ...
              {organizationLabels.length === 0 ? (
                <Empty>
                  <EmptyHeader>
                    ...
                    <EmptyTitle>
                      {t("settings:organizationLabels.empty", {
                        defaultValue:
                      ...
                      {canEdit && (
                        <div className="flex items-center gap-1 flex-shrink-0">
                          <Button
                            ...
                            size="icon"
                            aria-label={t(
                              "settings:organizationLabels.editLabel",
                          ...
                          <Button
                            ...
                            size="icon"
                            aria-label={t(
                              "settings:organizationLabels.deleteLabel",
                              { defaultValue: "Delete" },
                            )}
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {t("settings:organizationLabels.createDescription", {
                defaultValue:
                  "Create a new label that can be used across tasks in this organization.",
              })}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="p-6 pt-1 space-y-4">
            <div className="space-y-2">
              <Label htmlFor="new-label-name">
                {t("settings:organizationLabels.nameLabel", {
              ...
              <Input
                ...
                placeholder={t("settings:organizationLabels.namePlaceholder", {
            ...
            <div className="space-y-2">
              <Label>
                {t("settings:organizationLabels.colorLabel", {
                  defaultValue: "Color",
                })}
              </Label>
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>
              {t("settings:organizationLabels.editLabel", {
                defaultValue: "Edit Label",
              })}
            </DialogTitle>
            <DialogDescription>
              {t("settings:organizationLabels.editDescription", {
          ...
          <DialogFooter>
            ...
            <Button onClick={handleEdit} disabled={updateLabel.isPending}>
              {t("settings:organizationLabels.saveLabel", {
                defaultValue: "Save",
              })}
            </Button>
          </DialogFooter>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("settings:organizationLabels.deleteConfirmTitle", {
                defaultValue: "Delete this label?",
              })}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t("settings:organizationLabels.deleteConfirmDescription", {
                defaultValue:
          ...
          <AlertDialogFooter>
            ...
            >
              {t("settings:organizationLabels.deleteLabel", {
                defaultValue: "Delete",
              })}
            </Button>
          </AlertDialogFooter>
